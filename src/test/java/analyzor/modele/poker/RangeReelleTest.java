...
public class RangeReelleTest {
    ...
    void echantillonRepresentatif() {
        ...
        float tempsInitial = System.currentTimeMillis();
        List<ComboReel> grandEchantillon = rangeReelle.obtenirEchantillon(nEchantillons);
        float tempsFinal = System.currentTimeMillis();
        System.out.println("Temps écoulé : " + (tempsFinal - tempsInitial));
        ...
        for (ComboIso comboIso : combosInitiaux.keySet()) {
            ...
            System.out.println("TEST EN COURS : " + proportionDepart + ", " + proportionArrivee);
